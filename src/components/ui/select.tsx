...
import { Flex } from '@/lib/nextgen-core-ui'
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'focus-visible:ring-[#222222]est  flex w-full      items-center  justify-between rounded-md px-4  py-3  text-sm text-[#3333333] file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-[#3333333] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 active:opacity-70 disabled:cursor-not-allowed disabled:opacity-50',
      className,
    )}
    {...props}
  >
